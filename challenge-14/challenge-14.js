...
*/
	console.log( '\nJust Numbers:' );
// ?
	var justNumbers = numberObjects.map(function(item) { // percorre todo o array retornando um novo array
	return item.number
})
...
// ?
	var justMod2Or3 = justNumbers.filter(function(item){ // cria novo array
