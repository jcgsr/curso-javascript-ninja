...
// ?
	...
	junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro
	de Luvas", foi um militar, político, abolicionista e monarquista brasileiro.`
...
// ?
	var newText = text.replace(/Manuel Marques de Sousa/g, 'Jovane Rocha')
	console.log(newText)
...
// ?
	...
	var newText2 = newText.replace(/brasileiro/g, 'recifense')
...
var newText3 = text.replace(/[0-9]/g, '-') // ou (/\d/g)
...
// ?
	...
	var newText4 = text.replace(/[D-Za-h]/g, '0')
...
// ?
var newText5 = text.replace(/a/gi, '4') // ou (/A|a/g) ou (/[Aa]/g)
